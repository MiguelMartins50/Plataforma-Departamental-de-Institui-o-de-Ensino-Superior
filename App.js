...
import AdicionarDocentesAdmin from "./screens/AdicionarDocentesAdmin.js";
...
function escolha() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="Admin" component={PerfilDocente} />
      <Stack.Screen
...
function publicacoess() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      />
      <Stack.Screen name="EditarProjeto" component={EditarPublicacao_Docente} />
    </Stack.Navigator>
  );
}
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Drawer.Screen name="Departamentos" component={departamentovisitante} />
      </Drawer.Navigator>*/}
      {/*<Drawer.Navigator
        initialRouteName="Inicio"
        drawerType="slide"
